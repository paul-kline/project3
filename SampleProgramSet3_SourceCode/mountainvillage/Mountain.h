...
public:
	...
	// The sin curve varies from yMin to sin_yMax; the cos curve varies from yMin to cos_yMax
	Mountain(double xMinIn, double xMaxIn, double yMin, double sin_yMax, double cos_yMax,
